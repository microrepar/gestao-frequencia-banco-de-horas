...
import les22018.web.controle.vh.FuncionarioViewHelper;
...
public class Servlet extends HttpServlet {
	...
	public Servlet() {
		vhs = new HashMap<String, IViewHelper>();
		  ...
		  vhs.put("/ControleFrequencia/CadastrarFuncionario", new FuncionarioViewHelper());
		  vhs.put("/ControleFrequencia/ConsultarFuncionario", new FuncionarioViewHelper());
