...
import les22018.core.impl.dao.DAOFuncionario;
...
public class Fachada implements IFachada {
	...
	public Fachada() {
		...
		List<IStrategy> rnsFuncionarioSalvar = new ArrayList<>();
		List<IStrategy> rnsFuncionarioConsultar = new ArrayList<>();
		...
		Map<String, List<IStrategy>> rnsFuncionario = new HashMap<>();
		Map<String, List<IStrategy>> rnsJornada = new HashMap<>();

		// inserindo mapa de regras de negocios de acordo com suas operações
		rnsFuncionario.put("SALVAR", rnsFuncionarioSalvar);
		rnsFuncionario.put("CONSULTAR", rnsFuncionarioConsultar);
		...
		// instanciando DAOs
		IDAO daoFuncionario = new DAOFuncionario();
		IDAO dao = new DAO();

		// mapeando classes com DAOs
		daos = new HashMap<String, IDAO>();
		daos.put(Funcionario.class.getName(), daoFuncionario);
